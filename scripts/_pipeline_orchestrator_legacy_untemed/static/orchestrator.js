...
function populateConfigs() {
    ...
    setVal('s2-remap-path', s2.remap_log_source ||
        '/mnt/rip/vicarius_drive/hopper/CVR_CLIP_forAI/TCRMPcvr_recodeSpecies/output/remap_log_20260331_215126.json');
        ...
        items.forEach((it, idx) => {
            ...
            tile.innerHTML = `
                ...
                <div style="display:flex;gap:4px;margin-top:4px">
                    <button class="btn btn-sm" style="flex:1;padding:2px;background:#1a5c32" onclick="verifyStep8('${encodeURIComponent(it.filename)}','yes', this)">✓</button>
                    <button class="btn btn-sm" style="flex:1;padding:2px;background:#5a1a2a" onclick="verifyStep8('${encodeURIComponent(it.filename)}','no', this)">✗</button>
